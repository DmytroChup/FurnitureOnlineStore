...
class PaymentHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_history" do
    assert_difference("PaymentHistory.count") do
      post payment_histories_url, params: { payment_history: { amount: @payment_history.amount, payment_date: @payment_history.payment_date, payment_id: @payment_history.payment_id, payment_method: @payment_history.payment_method, user_id: @payment_history.user_id } }
    end
  ...
  test "should update payment_history" do
    patch payment_history_url(@payment_history), params: { payment_history: { amount: @payment_history.amount, payment_date: @payment_history.payment_date, payment_id: @payment_history.payment_id, payment_method: @payment_history.payment_method, user_id: @payment_history.user_id } }
